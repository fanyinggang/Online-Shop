			...
			<div class="row">
			  <div class="col-md-12">
				 <div class="header-left">
					 <div class="logo">
						<a href="index.html"><img src="${ctx }/static/images/logo1.jpg" alt=""/></a>
					 </div>
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="${ctx }/static/images/nav.png" alt="" /></a>
						    <ul class="nav" id="nav">
						    	<li><a href="shop.html">${nickname }</a></li>
	...
	<!-- start slider -->
       <div id="fwslider">
         <div class="slider_container">
            <div class="slide"> 
                <!-- Slide image -->
               <img src="${ctx }/static/images/bg001.jpg" class="${ctx }/static/img-responsive" alt=""/>
                <!-- /Slide image -->
                <!-- Texts container -->
            ...
            <div class="slide">
               <img src="${ctx }/static/images/bg002.jpg" class="${ctx }/static/img-responsive" alt=""/>
                <div class="slide_content">
                    <div class="slide_content_wrap">
                       <!--<div class="button"><a href="#">See Details</a></div>-->
                    </div>
            ...
            <div class="slide">
               <img src="${ctx }/static/images/bg003.jpg" class="${ctx }/static/img-responsive" alt=""/>
                <div class="slide_content">
                    <div class="slide_content_wrap">
                       <!--<div class="button"><a href="#">See Details</a></div>-->
                    </div>
	  ...
	  <div class="main">
		<div class="content-top">
			...
			<div class="close_but"><i class="close1"> </i></div>
				<ul id="flexiselDemo3">
				<li><img src="${ctx }/static/images/xie1.jpg" /></li>
				<li><img src="${ctx }/static/images/xie2.jpg" /></li>
				<li><img src="${ctx }/static/images/xie3.jpg" /></li>
				<li><img src="${ctx }/static/images/xie4.jpg" /></li>
				<li><img src="${ctx }/static/images/xie5.jpg" /></li>
			</ul>
		<h3>Adidas系列</h3>
			<script type="text/javascript">
	...
	<div class="content-bottom">
		<div class="container">
			<div class="row content_bottom-text">
			  <div class="col-md-7">
				<h3>nike<br>跑步鞋</h3>
				<p class="m_1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NIKE公司总部位于美国俄勒冈州波特兰市。公司生产的体育用品包罗万象，例如服装，鞋类，运动器材等。NIKE是全球著名的体育运动品牌，英文原意指希腊胜利女神，中文译为耐克。</p>
				<p class="m_2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;据权威数据机构IDC统计，NIKE 2016年已成为中国运动鞋市场出货量第一品牌。</p>
			  </div>
			</div>
		</div>
	</div>
